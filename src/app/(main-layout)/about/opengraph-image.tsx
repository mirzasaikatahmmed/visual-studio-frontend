...
export const alt = "About Visual Studios & Events — South Asian Wedding Photographers in Brooklyn NY";
    ...
    (
      ...
      >
        ...
        <div style={{ fontSize: "30px", color: "rgba(255,255,255,0.55)", maxWidth: "720px", lineHeight: 1.4 }}>
          South Asian & Muslim wedding photographers based in Brooklyn, NY
        </div>
