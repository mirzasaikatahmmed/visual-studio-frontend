...
export const alt = "Cinematic Wedding Films for South Asian & Muslim Weddings — Visual Studios & Events NY";
    ...
    (
      ...
      >
        ...
        <div style={{ fontSize: "30px", color: "rgba(255,255,255,0.55)", maxWidth: "720px", lineHeight: 1.4 }}>
          Wedding videography for South Asian & Muslim weddings in NY
        </div>
