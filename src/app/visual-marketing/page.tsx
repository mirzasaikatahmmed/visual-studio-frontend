  ...
  return (
    <div className="flex flex-col min-h-screen pt-24">
      ...
      <section className="container mx-auto px-4 py-16 text-center max-w-4xl">
        <h1 className="text-4xl md:text-6xl font-bold tracking-tighter uppercase mb-6">Visual Marketing</h1>
        <p className="text-xl text-muted-foreground mb-8">
          We don't just take pictures. We create visual assets that drive engagement, elevate your brand, and convert audiences into customers.
        </p>
