    ...
    packages: [
      {
        ...
        features: [
          ...
          { label: "Edited",     value: "10 professionally edited high-res photos" },
          { label: "Retouched",  value: "5 hand-retouched portraits" },
      ...
      },
      {
        ...
        features: [
          ...
          { label: "Edited",     value: "30 professionally edited high-res photos" },
          { label: "Retouched",  value: "10 hand-retouched portraits" },
          { label: "Lighting",   value: "Professional lighting setup" },
          { label: "Delivery",   value: "Pixieset gallery with digital download" },
        ],
      },
      {
        ...
        features: [
          ...
          { label: "Edited",     value: "60 professionally edited high-res photos" },
          { label: "Retouched",  value: "20 hand-retouched portraits" },
      ...
      },
      {
        ...
        features: [
          ...
          { label: "Edited",     value: "100 professionally edited high-res photos" },
          { label: "Retouched",  value: "30 hand-retouched portraits" },
    ...
    packages: [
      {
        num: "01", name: "Essentials", hours: 4, guests: "Up to 100 guests",
        features: [
          { label: "Coverage", value: "4 hours of videography" },
          { label: "Films",    value: "1 edited highlight film" },
          { label: "Lighting", value: "Professional lighting setup" },
          { label: "Delivery", value: "Private digital link delivery" },
        ],
      },
      {
        num: "02", name: "Classic", hours: 8, guests: "Up to 200 guests",
        features: [
          { label: "Coverage", value: "8 hours of videography" },
          { label: "Films",    value: "2 edited films — ceremony & reception highlight" },
          { label: "Editing",  value: "Full cinematic editing" },
          { label: "Lighting", value: "Professional lighting setup" },
          { label: "Delivery", value: "Private digital link delivery" },
        ],
      },
      {
        num: "03", name: "Signature", hours: 12, guests: "Up to 300 guests", popular: true,
        features: [
          { label: "Coverage", value: "12 hours of videography" },
          { label: "Films",    value: "3 edited films — ceremony, reception & trailer" },
          { label: "Editing",  value: "Cinematic editing with full color grading" },
          { label: "Support",  value: "Professional lighting + on-site assistant" },
          { label: "Delivery", value: "Private digital link delivery" },
        ],
      },
      {
        ...
        features: [
          { label: "Exclusive", value: "Full Documentary Film (30–60 min)", exclusive: true },
          { label: "Coverage",  value: "16 hours of full-day videography" },
          { label: "Films",     value: "4 edited films — ceremony, reception, couple highlight & trailer" },
          { label: "Editing",   value: "Premium cinematic editing with assistant team" },
          { label: "Lighting",  value: "Professional lighting, full-day cinematic coverage" },
          { label: "Delivery",  value: "Private digital link delivery" },
        ],
      },
    ],
    ...
    packages: [
      ...
      },
      {
        ...
        features: [
          ...
          { label: "Edited",    value: "100 professionally edited high-res photos" },
          { label: "Retouched", value: "25 hand-retouched portraits" },
      ...
      },
      {
        ...
        features: [
          ...
          { label: "Films",     value: "3 edited films — ceremony, reception & trailer" },
          { label: "Edited",    value: "150 professionally edited high-res photos" },
          { label: "Retouched", value: "40 hand-retouched portraits" },
          { label: "Support",   value: "Professional lighting + on-site assistant" },
          { label: "Editing",   value: "Full photo & video editing" },
          { label: "Delivery",  value: "Pixieset gallery + private video link" },
        ],
      },
      {
        ...
        features: [
          ...
          { label: "Films",      value: "4 edited films — ceremony, reception, couple highlight & trailer" },
          { label: "Edited",     value: "200 professionally edited high-res photos" },
          { label: "Retouched",  value: "60 hand-retouched portraits" },
