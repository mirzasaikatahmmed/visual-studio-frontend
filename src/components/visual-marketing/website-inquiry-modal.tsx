...
export function WebsiteInquiryModal({ open, onClose }: Props) {
  ...
  const labelCls = "block text-xs font-bold uppercase tracking-widest text-black dark:text-white/50 mb-1.5";
          ...
          >
            ...
            <div className="sticky top-0 z-10 bg-white dark:bg-zinc-950 border-b border-zinc-200 dark:border-zinc-800 px-8 py-5 flex items-center justify-between rounded-t-3xl">
              <div>
                ...
                <h2 className="text-xl font-bold uppercase tracking-tight text-black dark:text-white">Build My Website</h2>
              </div>
              <button
                onClick={handleClose}
