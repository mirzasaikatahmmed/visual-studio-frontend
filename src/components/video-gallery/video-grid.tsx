...
// Real data from API + dummy entries for Commercial / Social Content / Same-Day Edit
const VIDEOS: VideoItem[] = [
  // Wedding — from live API
  {
    id: 4,
    title: "Sophia & James | Cinematic Highlights",
    category: "Wedding",
    embedUrl: "https://www.youtube.com/embed/zyEOKMQ7p74?si=UK0AsQg83qPDUf8p",
    thumbnailUrl: "https://img.youtube.com/vi/zyEOKMQ7p74/maxresdefault.jpg",
    featured: true,
  },
  {
    id: 3,
    title: "The Grand Royal Wedding",
    category: "Wedding",
    embedUrl: "https://www.youtube.com/embed/7bhLLDGfKWo?si=0RWYHSohg6YBqEUO",
    thumbnailUrl: "https://img.youtube.com/vi/7bhLLDGfKWo/maxresdefault.jpg",
    featured: true,
  },
  {
    id: 2,
    title: "Sarah & Michael | Destination Wedding",
    category: "Wedding",
    embedUrl: "https://www.youtube.com/embed/ZjKqKnTgeIA?si=2MaaovGNiN3YtheY",
    thumbnailUrl: "https://img.youtube.com/vi/ZjKqKnTgeIA/maxresdefault.jpg",
    featured: true,
  },
  {
    id: 1,
    title: "Emily & David | A Love Story",
    category: "Wedding",
    embedUrl: "https://www.youtube.com/embed/mzzIpM6Sw6U",
    thumbnailUrl: "https://img.youtube.com/vi/mzzIpM6Sw6U/maxresdefault.jpg",
    featured: true,
  },

  // Commercial — dummy (replace with real work)
  {
    id: 5,
    title: "Brooklyn Bridal Boutique — Brand Film",
    category: "Commercial",
  ...
  {
    id: 6,
    title: "Halal Restaurant Launch — Promo",
    category: "Commercial",
  ...
  // Social Content — dummy (replace with real reels)
  {
    id: 7,
    title: "Mehndi Reel — Instagram Cut",
  ...
  // Same-Day Edit — dummy (replace with real SDEs)
  {
    id: 9,
    title: "Priya & Raj — Same-Day Edit",
  ...
  {
    id: 10,
    title: "Nasheed & Sara — Wedding Day SDE",
    category: "Same-Day Edit",
