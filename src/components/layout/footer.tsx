...
<li><Link href="/store" className="hover:text-white transition-colors hover:translate-x-2 inline-block transform duration-300">Print Store</Link></li>
           ...
           <motion.div variants={itemVariants}>
              ...
              <ul className="space-y-3 text-foreground/70">
                 <li><Link href="/packages" className="hover:text-white transition-colors flex items-center gap-2 font-medium hover:translate-x-2 transform duration-300"><ArrowUpRight size={14} className="text-brand-400"/> Build Your Package</Link></li>
