  ...
  return (
    <footer className="bg-foreground text-background pt-24 pb-12">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-24 pb-24 border-b border-background/20">
          ...
          <div>
            ...
            <form className="flex max-w-md">
              <input 
                ...
                className="bg-transparent border-b border-background/50 flex-1 py-3 px-2 outline-none focus:border-background transition-colors placeholder:text-background/40"
                required
              />
              <button type="submit" className="border-b border-background font-bold tracking-widest uppercase text-sm hover:text-background/80 transition-colors">
                Subscribe
              </button>
            </form>
          </div>
          ...
          <div>
             ...
             <a href="#" className="inline-flex items-center gap-2 mt-6 font-bold tracking-widest uppercase text-sm border-b border-background pb-1 hover:text-background/80">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
           ...
           <div>
              ...
              <ul className="space-y-3 text-background/70">
                 <li><Link href="/portfolio" className="hover:text-background transition-colors">Portfolio</Link></li>
                 <li><Link href="/visual-marketing" className="hover:text-background transition-colors">Visual Marketing</Link></li>
                 <li><Link href="/events" className="hover:text-background transition-colors">Events & Decor</Link></li>
                 <li><Link href="/store" className="hover:text-background transition-colors">Print Store</Link></li>
              </ul>
           </div>
           ...
           <div>
              ...
              <ul className="space-y-3 text-background/70">
                 <li><a href="#" className="hover:text-background transition-colors flex items-center gap-2 font-medium"><ArrowUpRight size={14}/> Client Portal</a></li>
                 <li><a href="#" className="hover:text-background transition-colors flex items-center gap-2 font-medium"><ArrowUpRight size={14}/> Download Pricing PDF</a></li>
                 <li><Link href="/faq" className="hover:text-background transition-colors flex items-center gap-2 font-medium"><ArrowUpRight size={14}/> FAQ & Booking Guide</Link></li>
              </ul>
           </div>
        </div>

        {/* Copyright */}
        <div className="pt-8 border-t border-background/20 flex flex-col md:flex-row items-center justify-between gap-4 text-xs tracking-widest uppercase text-background/50">
